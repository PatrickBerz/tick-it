...
import { Stack, Image, Form, Button, ToggleButton, ToggleButtonGroup } from 'react-bootstrap';
      ...
      <div>
          ...
          <Form className="col-md-4 mt-4 mx-auto">
              ...
              <br></br>
                ...
                <Button type="submit" className="mb-3 mx-auto" style={{marginTop:'30px'}}>Place Order</Button>
                </Link>
          </Form>
      </div>
  )
